            ...
            <div className="container mx-auto px-4">
                ...
                <div className="prose prose-invert max-w-none space-y-8">
                    <section>
                        ...
                        <p className="text-gray-300 mb-4">
                            Dhvani Cast is committed to maintaining a safe digital environment and enforcing <strong>zero tolerance toward Child Sexual Abuse and Exploitation (CSAE)</strong>.
                        </p>
                        <p className="text-gray-300 mb-4">
                            Although Dhvani Cast is a <strong>strictly 18+ platform</strong>, the company acknowledges its responsibility to prevent, detect, report, and remove any form of child sexual abuse material or grooming behavior that may appear on the platform, intentionally or unintentionally.
                        </p>
                        <p className="text-gray-300">
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                            <li>All users of Dhvani Cast</li>
